...
`"limit"` events are typically not necessary for describing version ranges. They
are more useful for git ranges, where it has more implications for the evaluation
